...
<section class="paralax-mf footer-paralax bg-image sect-mt4 route"
    style="background-image: url({{ asset('assets/img/overlay-bg.jpg') }})">
                    ...
                    <div id="contact" class="box-shadow-full">
                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <button type="submit" class="button button-a button-big button-rouded"
                                                    id="enviar_mensaje">Enviar Mensaje</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="socials">
                                    <ul>
                                        <li><a href="https://www.facebook.com/profile.php?id=100007085074863"
                                                target="blank"><span class="ico-circle"><i
                                                        class="ion-social-facebook"></i></span></a></li>
                                        <li><a href="https://www.instagram.com/oscar_ruiz0502/?hl=es-la"
                                                target="blank"><span class="ico-circle"><i
                                                        class="ion-social-instagram"></i></span></a></li>
                                        <li><a href="https://twitter.com/oscarruiz05" target="blank"><span
                                                    class="ico-circle"><i class="ion-social-twitter"></i></span></a>
                                        </li>
                                        <li><a href="https://www.linkedin.com/in/oscar-daniel-ruiz-a340521a0/"
                                                target="blank"><span class="ico-circle"><i
                                                        class="ion-social-linkedin"></i></span></a></li>
                                        <li><a href="https://github.com/oscarruiz05" target="blank"><span
                                                    class="ico-circle"><i class="ion-social-github"></i></span></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="copyright-box">
                        <p class="copyright">&copy; Copyright <strong>Oscar Ruiz</strong>. Todos los derechos
                            reservados
                        </p>
                    </div>
                </div>
